    ...
    return `
      <div class="col-4">
        <div class="card p-4 h-100">
          <img src="${this.image}" alt="" class="w-100" style="height: 14rem;"/>
          <p class="body-medium mt-4">${this.manufacture}</p>
          <p class="body-bold">Rp ${this.rentPerDay} / hari</p>
          <p class="body-light">
          ${this.description}
          </p>
          <p class="body-light my-auto py-2">
            <span class="pe-2"
              ><svg
          ...
          <button class="btn button-primary float-end mt-4" type="submit">
            Pilih Mobil
          </button>
        </div>
      </div>
